...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1f19b7e2dbd9809784a2daa429207ed7,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AisaFun', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://test.aisa.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Aisa, Ai', // 网站关键词 英文逗号隔开
